...
public class NginxRunSettingsForm {
    ...
    public NginxRunSettingsForm(final NginxRunSettingsEditor.Mediator mediator) {
        ...
        this.$$$setupUI$$$();
        this.serverCombo.setRenderer(new NginxServerComboboxRenderer());
        this.serverCombo.addActionListener(e -> mediator.onChooseDescriptor((NginxServerDescriptor) this.serverCombo.getSelectedItem()));

        this.configureButton.addActionListener(
                e -> mediator.showServerManagerDialog()
        );

        this.showHttpLogCheckBox.addActionListener(e -> mediator.onHttpLogCheckboxAction());

        this.showErrorLogCheckBox.addActionListener(e -> mediator.onErrorLogCheckboxAction());
    ...
    private void createUIComponents() {
        this.explanationLabel = new JLabel(NginxBundle.message("run.layoutExplanation"));
        this.explanationLabel.setUI(new MultiLineLabelUI());
    }
    ...
    private void $$$setupUI$$$() {
        ...
        this.$$$loadButtonText$$$(configureButton, ResourceBundle.getBundle("net/ishchenko/idea/nginx/NginxBundle")
                .getString("run.configureButton"));
        ...
        panel1.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), ResourceBundle.getBundle("net/ishchenko/idea/nginx/NginxBundle")
                .getString("run.serverinfo")));
        final JLabel label1 = new JLabel();
        this.$$$loadLabelText$$$(label1, ResourceBundle.getBundle("net/ishchenko/idea/nginx/NginxBundle")
                .getString("run.executable"));
        panel1.add(label1, cc.xy(1, 3));
        final JLabel label2 = new JLabel();
        this.$$$loadLabelText$$$(label2, ResourceBundle.getBundle("net/ishchenko/idea/nginx/NginxBundle")
                .getString("run.configuration"));
        ...
        this.$$$loadLabelText$$$(label3, ResourceBundle.getBundle("net/ishchenko/idea/nginx/NginxBundle")
                .getString("run.globals"));
        ...
        this.$$$loadLabelText$$$(label4, ResourceBundle.getBundle("net/ishchenko/idea/nginx/NginxBundle")
                .getString("run.pidpath"));
        ...
        panel2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), ResourceBundle.getBundle("net/ishchenko/idea/nginx/NginxBundle")
                .getString("run.logFiles")));
        showHttpLogCheckBox = new JCheckBox();
        this.$$$loadButtonText$$$(showHttpLogCheckBox, ResourceBundle.getBundle("net/ishchenko/idea/nginx/NginxBundle")
                .getString("run.showAccessLog"));
        ...
        this.$$$loadButtonText$$$(showErrorLogCheckBox, ResourceBundle.getBundle("net/ishchenko/idea/nginx/NginxBundle")
                .getString("run.showErrorLog"));
    ...
    private static class NginxServerComboboxRenderer extends BasicComboBoxRenderer {
        ...
        public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected,
            ...
            if(value != null) {
                result.setIcon(IconLoader.getIcon("/nginx.png", NginxRunSettingsForm.class));
